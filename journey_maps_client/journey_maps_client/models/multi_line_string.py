...
class MultiLineString:
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        for coordinates_item_data in self.coordinates:
            coordinates_item = []
            for componentsschemas_line_string_coordinates_item_data in coordinates_item_data:
                componentsschemas_line_string_coordinates_item = componentsschemas_line_string_coordinates_item_data

                coordinates_item.append(componentsschemas_line_string_coordinates_item)
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        for coordinates_item_data in _coordinates:
            ...
            for componentsschemas_line_string_coordinates_item_data in _coordinates_item:
