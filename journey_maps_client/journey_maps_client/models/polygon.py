...
class Polygon:
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        for coordinates_item_data in self.coordinates:
            coordinates_item = []
            for componentsschemas_linear_ring_item_data in coordinates_item_data:
                componentsschemas_linear_ring_item = componentsschemas_linear_ring_item_data

                coordinates_item.append(componentsschemas_linear_ring_item)
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        for coordinates_item_data in _coordinates:
            ...
            for componentsschemas_linear_ring_item_data in _coordinates_item:
