...
from ...models.get_places_by_coordinates_geojson_accept_language import GetPlacesByCoordinatesGeojsonAcceptLanguage
from ...models.get_places_by_coordinates_geojson_type_item import GetPlacesByCoordinatesGeojsonTypeItem
...
def _get_kwargs(
    *,
    ...
    type: Union[Unset, None, List[GetPlacesByCoordinatesGeojsonTypeItem]] = UNSET,
    include_vehicle_modes: Union[Unset, None, bool] = False,
    request_id: Union[Unset, str] = UNSET,
    accept_language: Union[
        Unset, GetPlacesByCoordinatesGeojsonAcceptLanguage
    ] = GetPlacesByCoordinatesGeojsonAcceptLanguage.EN,
) -> Dict[str, Any]:
    headers = {}
    ...
    return {
        "method": "get",
        "url": "/v3/places/by-coordinates-geojson",
        "params": params,
        "headers": headers,
    }
...
def sync_detailed(
    *,
    ...
    """Get places nearby given coordinates in GeoJson. (Alternately use `v3/places/by-coordinates`
    instead.)

     Returns a list of `Place's` ordered by their distance to the centre coordinates.

    Args:
        center (str):  Example: [8.5441, 47.4115].
        radius (Union[Unset, None, int]):  Default: 1000.
        limit (Union[Unset, None, int]):  Default: 10. Example: 10.
        type (Union[Unset, None, List[GetPlacesByCoordinatesGeojsonTypeItem]]):
        include_vehicle_modes (Union[Unset, None, bool]):
        request_id (Union[Unset, str]):
        accept_language (Union[Unset, GetPlacesByCoordinatesGeojsonAcceptLanguage]):  Default:
            GetPlacesByCoordinatesGeojsonAcceptLanguage.EN.
