...
from ...models.get_trips_by_origin_and_destination_accept_language import GetTripsByOriginAndDestinationAcceptLanguage
...
def _get_kwargs(
    *,
    ...
    accept_language: Union[
        Unset, GetTripsByOriginAndDestinationAcceptLanguage
    ] = GetTripsByOriginAndDestinationAcceptLanguage.EN,
) -> Dict[str, Any]:
    headers = {}
    ...
    return {
        "method": "post",
        "url": "/v3/trips/by-origin-destination",
        "json": json_json_body,
        "headers": headers,
    }
...
def sync_detailed(
    *,
    ...
    your query-parameters, such as via, individual change time (ICT) etc.<br>Between 0 and about 12 hits
    are expectable, related to realtime circumstances.

    Args:
        request_id (Union[Unset, str]):
        accept_language (Union[Unset, GetTripsByOriginAndDestinationAcceptLanguage]):  Default:
            GetTripsByOriginAndDestinationAcceptLanguage.EN.
