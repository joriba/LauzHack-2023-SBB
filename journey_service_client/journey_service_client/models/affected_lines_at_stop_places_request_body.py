...
T = TypeVar("T", bound="AffectedLinesAtStopPlacesRequestBody")


@_attrs_define
class AffectedLinesAtStopPlacesRequestBody:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        affected_lines_at_stop_places_request_body = cls(
        ...
        affected_lines_at_stop_places_request_body.additional_properties = d
        return affected_lines_at_stop_places_request_body
