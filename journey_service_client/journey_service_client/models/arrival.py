...
from ..models.arrival_journey_status import ArrivalJourneyStatus
...
T = TypeVar("T", bound="Arrival")


@_attrs_define
class Arrival:
    """Arrival at a specific stop resp. kind of view of JourneyDetail from its final direction.
    ...
    Attributes:
        ...
        journey_status (ArrivalJourneyStatus): Contains the status of the journey. Example: PLANNED.
        transport_products (List['TransportProductV2']):
        arrival (StopV2): A stop represents a specific location (typically a STATION) of a leg or a complete journey-
        ...
        origin (Union[Unset, StopV2]): A stop represents a specific location (typically a STATION) of a leg or a
    ...
    journey_status: ArrivalJourneyStatus
    transport_products: List["TransportProductV2"]
    arrival: "StopV2"
    stops: List["StopV2"]
    attributes: List["Note"]
    ...
    origin: Union[Unset, "StopV2"] = UNSET
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        journey_status = ArrivalJourneyStatus(d.pop("journeyStatus"))
        ...
        arrival = StopV2.from_dict(d.pop("arrival"))
        ...
        origin: Union[Unset, StopV2]
        if isinstance(_origin, Unset):
            origin = UNSET
        else:
            origin = StopV2.from_dict(_origin)
        ...
        arrival.additional_properties = d
        return arrival
