...
T = TypeVar("T", bound="AffectedByLinesRequestBody")


@_attrs_define
class AffectedByLinesRequestBody:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        affected_by_lines_request_body = cls(
        ...
        affected_by_lines_request_body.additional_properties = d
        return affected_by_lines_request_body
